/**
 * UI Layouts Adapter — Frontend UI Components
 *
 * Browses UI layout components on ui-layouts.com.
 * No API key needed.
 *
 * invoke({ query? })
 *   query: string — component search term
 */

const BASE = "https://www.ui-layouts.com";
...
async function invoke(params = {}) {
  ...
  try {
    ...
    return { query, url, title, description, note: "Open URL to browse UI layout components" };
  } catch (err) {
...
function describe() {
  return {
    name: "UI Layouts — Frontend Components",
    params: {
